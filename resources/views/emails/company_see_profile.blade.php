                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em; text-align: center;color: black;">
                                        ...
                                        <p>Hiện tại nhà tuyển dụng đã xem và đang đánh giá hồ sơ mà
                                            <b>{{ $data['name'] }}</b>
                                            đã ứng tuyển vào vị trí <a
                                                href="{{ env('CLIENT_HOST') }}/job-detail/{{ $data['href'] }}/{{ $data['id'] }}"><b>{{ $data['job_post_title'] }}</b></a>
                                        </p>
                                        </p>
                                    </div>
